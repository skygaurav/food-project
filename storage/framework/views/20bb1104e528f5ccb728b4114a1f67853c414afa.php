<nav>
    ...
    <div class="sidebar-section">
        ...
        <a href="/admin/admins" class="nav-link <?php echo e(request()->is('admin/admins*') ? 'active' : ''); ?>">
            <svg class="icon nav-icon"><use href="#icon-user"></use></svg>
            Admin Users
        </a>
        <a href="/admin/users" class="nav-link <?php echo e(request()->is('admin/users*') ? 'active' : ''); ?>">
    ...
    <div class="sidebar-section">
        ...
        <a href="/admin/cms-pages" class="nav-link <?php echo e(request()->is('admin/cms-pages*') ? 'active' : ''); ?>">
