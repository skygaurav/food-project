...
<head>
    ...
    <title><?php echo $__env->yieldContent('meta_title', $seoSettings['default_meta_title'] ?? 'FOODCITA - Discover Delicious Dishes'); ?></title>
    <meta name="description" content="<?php echo $__env->yieldContent('meta_description', $seoSettings['default_meta_description'] ?? 'Share your favorite meals and explore dishes loved by food enthusiasts in your city.'); ?>">
    <meta name="keywords" content="<?php echo $__env->yieldContent('meta_keywords', $seoSettings['default_meta_keywords'] ?? 'food, dishes, restaurants, reviews, dining'); ?>">
...
<body>
    <?php echo $__env->make('partials.icons', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
        ...
        <div class="footer-container">
            <div class="footer-grid">
                ...
                <div class="footer-section">
                    <h4>Connect</h4>
                    <ul>
                        <?php if($seoSettings['social_facebook'] ?? null): ?>
                        <li><a href="<?php echo e($seoSettings['social_facebook']); ?>" target="_blank" rel="noopener"><svg class="icon icon-sm"><use href="#icon-globe"></use></svg> Facebook</a></li>
                        <?php endif; ?>
                        <?php if($seoSettings['social_instagram'] ?? null): ?>
                        <li><a href="<?php echo e($seoSettings['social_instagram']); ?>" target="_blank" rel="noopener"><svg class="icon icon-sm"><use href="#icon-camera"></use></svg> Instagram</a></li>
                        <?php endif; ?>
                        <?php if($seoSettings['social_twitter'] ?? null): ?>
                        <li><a href="<?php echo e($seoSettings['social_twitter']); ?>" target="_blank" rel="noopener"><svg class="icon icon-sm"><use href="#icon-comment"></use></svg> Twitter / X</a></li>
                        <?php endif; ?>
                        <?php if($seoSettings['social_youtube'] ?? null): ?>
                        <li><a href="<?php echo e($seoSettings['social_youtube']); ?>" target="_blank" rel="noopener"><svg class="icon icon-sm"><use href="#icon-external-link"></use></svg> YouTube</a></li>
                        <?php endif; ?>
                        <?php if($seoSettings['social_tiktok'] ?? null): ?>
                        <li><a href="<?php echo e($seoSettings['social_tiktok']); ?>" target="_blank" rel="noopener"><svg class="icon icon-sm"><use href="#icon-external-link"></use></svg> TikTok</a></li>
                        <?php endif; ?>
                        <?php if(!($seoSettings['social_facebook'] ?? null) && !($seoSettings['social_instagram'] ?? null) && !($seoSettings['social_twitter'] ?? null) && !($seoSettings['social_youtube'] ?? null) && !($seoSettings['social_tiktok'] ?? null)): ?>
            ...
            <div class="footer-bottom">
                <p>&copy; <?php echo e(date('Y')); ?> <?php echo e($seoSettings['site_name'] ?? 'FOODCITA'); ?>. All rights reserved.</p>
                <div class="social-links">
                    <?php if($seoSettings['social_facebook'] ?? null): ?>
                    <a href="<?php echo e($seoSettings['social_facebook']); ?>" target="_blank" rel="noopener"><svg class="icon"><use href="#icon-globe"></use></svg></a>
                    <?php endif; ?>
                    <?php if($seoSettings['social_instagram'] ?? null): ?>
                    <a href="<?php echo e($seoSettings['social_instagram']); ?>" target="_blank" rel="noopener"><svg class="icon"><use href="#icon-camera"></use></svg></a>
                    <?php endif; ?>
                    <?php if($seoSettings['social_twitter'] ?? null): ?>
                    <a href="<?php echo e($seoSettings['social_twitter']); ?>" target="_blank" rel="noopener"><svg class="icon"><use href="#icon-comment"></use></svg></a>
                    <?php endif; ?>
                </div>
            </div>
        </div>
