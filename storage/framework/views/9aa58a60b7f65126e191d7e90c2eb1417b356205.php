...
<head>
    ...
    <title><?php echo $__env->yieldContent('title', 'Admin'); ?> — FOODCITA</title>
...
<body>
    ...
    <header class="admin-header">
        ...
        <div class="header-actions">
            ...
            <form method="POST" action="<?php echo e(url('/admin/logout')); ?>" style="margin:0">
                <?php echo csrf_field(); ?>
    ...
    <div class="admin-wrapper">
        <aside class="admin-sidebar">
            <?php echo $__env->make('admin._nav', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
        </aside>
