            ...
            <form id="restaurant-form">
                ...
                <div class="form-row">
                    <div class="form-group">
                        ...
                        <input type="tel" name="phone" value="<?php echo e($restaurant->phone ?? ''); ?>" class="form-control" placeholder="e.g., +1 (555) 123-4567" />
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div style="display: flex; gap: 1.5rem; padding: 0.75rem 0;">
                            <label style="display: flex; align-items: center; gap: 0.5rem; cursor: pointer;">
                                <input type="radio" name="reservation" value="1" <?php echo e(isset($restaurant) && $restaurant->reservation ? 'checked' : ''); ?> style="accent-color: var(--primary);">
                                <span>Yes</span>
                            </label>
                            <label style="display: flex; align-items: center; gap: 0.5rem; cursor: pointer;">
                                <input type="radio" name="reservation" value="0" <?php echo e(!isset($restaurant) || !$restaurant->reservation ? 'checked' : ''); ?> style="accent-color: var(--primary);">
                                <span>No</span>
                            </label>
                        </div>
                    </div>
                ...
                <div class="form-group">
                    ...
                    <div style="display: flex; gap: 1.5rem; padding: 0.75rem 0;">
                        <label style="display: flex; align-items: center; gap: 0.5rem; cursor: pointer;">
                            <input type="radio" name="is_approved" value="1" <?php echo e($restaurant->is_approved ? 'checked' : ''); ?> style="accent-color: var(--primary);">
                            <span><span class="badge badge-success">Approved</span></span>
                        </label>
                        <label style="display: flex; align-items: center; gap: 0.5rem; cursor: pointer;">
                            <input type="radio" name="is_approved" value="0" <?php echo e(!$restaurant->is_approved ? 'checked' : ''); ?> style="accent-color: var(--primary);">
                ...
                <div class="form-actions">
                    <button type="submit" class="btn btn-primary">
                        <svg class="icon"><use href="#icon-save"></use></svg> <?php echo e($restaurant->exists ? 'Update Restaurant' : 'Create Restaurant'); ?>
