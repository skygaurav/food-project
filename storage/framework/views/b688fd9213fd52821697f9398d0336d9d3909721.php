<?php $__env->startSection('title', $page ? 'Edit Page' : 'Add Page'); ?>

<?php $__env->startSection('content'); ?>
    <nav class="breadcrumb">
        <a href="/admin/cms-pages">CMS Pages</a>
        <span>/</span>
        <span><?php echo e($page ? 'Edit Page' : 'Add Page'); ?></span>
    </nav>

    <div class="page-header">
        <div>
            <h1 class="page-title"><?php echo e($page ? 'Edit Page' : 'Add New Page'); ?></h1>
            <p class="page-subtitle"><?php echo e($page ? 'Update page content and settings' : 'Create a new static content page'); ?></p>
        </div>
    </div>
            ...
            <form id="cms-form" class="form">
                <div class="form-row">
                    <div class="form-group" style="flex: 2;">
                        ...
                        <input type="text" id="title" name="title" class="form-control" 
                               value="<?php echo e($page->title ?? ''); ?>" required placeholder="e.g. About Us, Privacy Policy">
                    </div>
                    <div class="form-group" style="flex: 1;">
                        <label for="slug" class="form-label">URL Slug</label>
                        <input type="text" id="slug" name="slug" class="form-control" 
                               value="<?php echo e($page->slug ?? ''); ?>" placeholder="auto-generated if empty">
                ...
                <div class="form-group">
                    ...
                    <textarea id="content" name="content" class="form-control" rows="15" 
                              placeholder="Enter page content here. HTML is supported."><?php echo e($page->content ?? ''); ?></textarea>
                ...
                <div class="form-row">
                    <div class="form-group">
                        ...
                        <input type="number" id="sort_order" name="sort_order" class="form-control" 
                               value="<?php echo e($page->sort_order ?? 0); ?>" min="0">
                        ...
                        <div class="toggle-group">
                            <label class="toggle-option">
                                <input type="radio" name="show_in_footer" value="1" 
                                       <?php echo e(($page->show_in_footer ?? true) ? 'checked' : ''); ?>>
                                <span>Yes</span>
                            </label>
                            <label class="toggle-option">
                                <input type="radio" name="show_in_footer" value="0" 
                                       <?php echo e(isset($page) && !$page->show_in_footer ? 'checked' : ''); ?>>
                                <span>No</span>
                            </label>
                        </div>
                    </div>
                        ...
                        <div class="toggle-group">
                            <label class="toggle-option">
                                <input type="radio" name="is_active" value="1" 
                                       <?php echo e(($page->is_active ?? true) ? 'checked' : ''); ?>>
                                <span>Active</span>
                            </label>
                            <label class="toggle-option">
                                <input type="radio" name="is_active" value="0" 
                                       <?php echo e(isset($page) && !$page->is_active ? 'checked' : ''); ?>>
                                <span>Inactive</span>
                            </label>
                        </div>
                    </div>
                ...
                <div class="form-group">
                    ...
                    <input type="text" id="meta_title" name="meta_title" class="form-control" 
                           value="<?php echo e($page->meta_title ?? ''); ?>" placeholder="Page-specific title for search engines">
                ...
                <div class="form-group">
                    ...
                    <textarea id="meta_description" name="meta_description" class="form-control" rows="2" 
                              placeholder="Brief description for search engine results"><?php echo e($page->meta_description ?? ''); ?></textarea>
                ...
                <div class="form-group">
                    ...
                    <input type="text" id="meta_keywords" name="meta_keywords" class="form-control" 
                           value="<?php echo e($page->meta_keywords ?? ''); ?>" placeholder="keyword1, keyword2, keyword3">
                ...
                <div class="form-actions">
                    ...
                    <button type="submit" class="btn btn-primary">
                        <span>💾</span> <?php echo e($page ? 'Update Page' : 'Create Page'); ?>
...
<script>
const pageId = <?php echo e($page->id ?? 'null'); ?>;
...
form.addEventListener('submit', async (e) => {
    ...
    try {
        ...
        submitBtn.innerHTML = '<span>💾</span> <?php echo e($page ? "Update Page" : "Create Page"); ?>';
    }
});
</script>
<?php $__env->stopPush(); ?>

<?php echo $__env->make('admin.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/resources/views/admin/cms_page_form.blade.php ENDPATH**/ ?>