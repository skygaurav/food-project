...
<body>
    <div class="container">
        ...
        <div style="text-align: center;">
            <a href="<?php echo e($resetUrl); ?>" class="btn">Reset My Password</a>
        </div>
        ...
        <p style="word-break: break-all; font-size: 13px; color: #94a3b8;"><?php echo e($resetUrl); ?></p>
        
        <div class="footer">
            <p>This email was sent to <?php echo e($user->email); ?></p>
            <p>&copy; <?php echo e(date('Y')); ?> FOODCITA. All rights reserved.</p>
        </div>
    </div>
</body>
</html>
<?php /**PATH /var/www/html/resources/views/emails/user-password-reset.blade.php ENDPATH**/ ?>