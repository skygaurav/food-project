...
<body class="font-serif bg-white text-slate-900">
    <div class="min-h-screen bg-white">
        <header class="bg-black py-6 text-center text-white">
            ...
            <p class="mt-2 text-sm text-slate-500">Secure console for restaurant and dish moderation</p>
        </header>
        <main class="mx-auto w-full max-w-3xl px-6 pb-16 pt-10">
            <div class="admin-card">
                <div class="admin-card-header">
                    <div>
                        <h2 class="text-2xl font-semibold">Administrator Login</h2>
                ...
                <div class="admin-card-body">
                    @if ($errors->any())
                        <div class="rounded border border-slate-400 bg-white p-4 text-sm text-slate-900">
                            <p>{{ $errors->first() }}</p>
                        </div>
                    @endif
