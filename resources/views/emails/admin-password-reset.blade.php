...
<body>
    <div class="container">
        ...
        <p>We received a request to reset the password for your {{ $seoSettings['site_name'] ?? 'FOODCITA' }} Admin account. Click the button below to create a new password:</p>
        ...
        <div class="footer">
            ...
            <p>&copy; {{ date('Y') }} {{ $seoSettings['site_name'] ?? 'FOODCITA' }} Admin. All rights reserved.</p>
        </div>
    </div>
</body>
</html>
